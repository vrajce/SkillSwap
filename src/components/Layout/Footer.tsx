    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              through an intuitive swipe-based matching system. Learn, teach, grow together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/leaderboard" className="text-gray-400 hover:text-orange-500 transition-colors">Leaderboard</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 SwapIT. All rights reserved. Built with ❤️ for skill sharing.</p>
        </div>
      </div>
    </footer>
  );
